...
### Важно!
По умолчанию плагин заменяет ваш ассет текстуры на масштабированный с новыми значениями длины и ширины (если вы хотите создать копию текстуры, то вам нужно поменять путь сохраняемого файла). 
