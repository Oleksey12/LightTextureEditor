...
### Важно!
По умолчанию плагин заменяет вашу текстуру на масштабированную с новыми значениями длины и ширины (если вы хотите создать масштабированную копию текстуры, то вам нужно поменять путь сохраняемого файла). 
